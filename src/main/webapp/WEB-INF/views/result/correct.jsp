...
<%--        <span class="two_text" style="font-size: 7em; font-family: 'Katuri'; color: #0d6efd;    padding-bottom: 5%;">정답입니다!</span>--%>
<%--    </div>--%>
<%--</div>--%>

<%--<div class="sellfish">--%>
<%--    <div class="pinkshellfish">--%>
<%--        <img src="/static/img/IDOPinkShellfish.png">--%>
<%--    </div>--%>
<%--    <div class="grayshellfish">--%>
<%--        <img src="/static/img/IDOGrayShellfish.png">--%>
<%--    </div>--%>
<%--    <div class="grayshellfish">--%>
<%--        <img src="/static/img/IDOGrayShellfish.png">--%>
<%--    </div>--%>
...
<%--<div class="sellfish">--%>
<%--    <div class="pinkshellfish">--%>
<%--        <img src="/static/img/IDOPinkShellfish.png" alt="Pink Shellfish">--%>
<%--    </div>--%>
<%--    <div class="grayshellfish">--%>
...
<div class="navigation">
    <div class="left">
        ...
        <div class="replay">
            <a href="/quiz/IDOLessonSelection1">
                <img src="/static/img/IDOPlayBack-button.png" alt="동화선택 아이콘"> 동화선택
            </a>
        </div>
    </div>
