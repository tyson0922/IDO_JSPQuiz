...
<head>
    ...
    <style>
        ...
        .main {
            ...
            padding-top: 50px; /* 틀렸습니다!와 IDOWrong25 위치를 조금 내려줌 */
        }
        ...
        .two_text {
            ...
            animation: animate 3s infinite; /* 갸우뚱 효과 적용 */
            text-shadow:
                    -2.5px -2.5px 0 #fff,
                    2.5px -2.5px 0 #fff,
                    -2.5px  2.5px 0 #fff,
        ...
        .progress-image {
            margin-top: 60px; /* "틀렸습니다!" 텍스트와 이미지 사이의 간격 조정 */
        }
...
<div class="main">
    ...
    <div class="progress-image">
        <img src="/static/img/IDOWrong25.png" alt="Progress 25%" style="width: 900px; height: auto;">
    </div>
</div>
